...
class CNN_GRU_Dataset(Dataset):
    def __init__(self, compiled_df, pixel_coords=pixel_coords, image_shape=(9, 18), timezone_str="Asia/Singapore", reject_zeros = True):
...
class CNN_GRU_Module(nn.Module):
    def __init__(self, num_channels=5, num_future_steps=5, hidden_size=512):
        super(CNN_GRU_Module, self).__init__()  # updated here
